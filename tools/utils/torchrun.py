...
"""
Adapted from https://github.com/pytorch/pytorch/blob/master/torch/distributed/run.py 
...
def config_from_args(args) -> Tuple[LaunchConfig, Union[Callable, str], List[str]]:
    ...
    if isinstance(args.training_script_args, str):
        args.training_script_args = ast.literal_eval(args.training_script_args)
    assert isinstance(args.training_script_args, (List, Tuple))
